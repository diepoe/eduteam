...
<h2 class="text-xl">Create your contribution</h2>
...
>
  <input
    ...
    class="self-start w-full m-1 transform scale-100 duration-300 rounded-md border-indigo-500 border-3 focus:border-8 hover:border-indigo-600 focus:scale-105 dark:bg-gray-700"
  />
  <br />
  <markdown-toolbar
